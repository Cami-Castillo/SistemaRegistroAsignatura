...
public class SistemaRegistroAsignatura {
    ...
    case 2:
        ...
        System.out.println("Docente ingresado con éxito");
        System.out.println("------------------------------------");
        System.out.println("RUT: "+docente1.getRut());
        System.out.println("Numero docente: "+docente1.getnroDocente());
        System.out.println("Nombre docente: "+docente1.getnombreDocente());
        System.out.println("Fecha Ingreso: "+docente1.getfechaIngreso());
        System.out.println("Sede: "+docente1.getSede());
    ...
    case 3:
        ...
        System.out.println("Asignatura ingresado con éxito");
        System.out.println("------------------------------------");
        System.out.println("Codigo Asignatura: "+asig1.getCodigo());
        System.out.println("Nombre de la asignatura "+asig1.getNombreAsignatura());
        System.out.println("Nombre del estudiante: "+asig1.getNombreEstudiante());
        System.out.println("Docente: "+asig1.getNombreProfesor());
        System.out.println("Nota 1: "+asig1.getNota1());
        System.out.println("Nota 2: "+asig1.getNota2());
        System.out.println("Nota 3: "+asig1.getNota3());
        System.out.println("Nota Examen: "+asig1.getNotaExamen());
